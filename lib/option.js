...
module.exports = {
    create: function (opts) {
        ...
        buster.extend(instance, argument.create());
    ...
    intersects: function (otherOption) {
        if (this.arrayIntersects(this.singleDashOptions,
                                 otherOption.singleDashOptions)) {
            return true;
        }

        if (this.arrayIntersects(this.doubleDashOptions,
                                 otherOption.doubleDashOptions)) {
            return true;
        }
    },
